    ...
    return (  
        ...
        <section className="find-store-container relative w-full bg-[#F7CD99] flex flex-col items-center overflow-hidden">
            ...
            <div className="h-screen w-full flex flex-col items-center justify-center z-10">
                <p className="text-sm md:text-md text-[#151414] font-black tracking-[0.5em] mb-6 uppercase opacity-50">{t("availableIn")}</p>
...
/>
            ...
            <footer className="w-full min-h-[80vh] bg-[#151414] text-white pt-7 md:pt-22 pb-2 md:pb-8 px-6 flex flex-col items-center justify-center z-10">
                   ...
                   <div className="h-[10vh] md:h-10 w-full" />
                    ...
                    <div className="relative w-[80vw] md:w-280 mb-10 md:mb-15">
                        ...
                        />
                        <button className="absolute end-4 md:end-8 top-1/2 -translate-y-1/2 text-black font-english font-medium  uppercase text-md tracking-tighter cursor-pointer hover:text-[#E31E24]">
                            {tf("submit")}
                        </button>
                    </div>
            ...
            />
                    ...
                    <div className="w-[85vw] flex flex-col md:flex-row items-center justify-between gap-2 md:mb-3 pt-4 md:pt-8">
                            ...
                            <a href="/" onClick={(e) => handleNavigation(e, "/")} className="font-bold uppercase text-2xl tracking-widest text-gray-200 transition-transform hover:-translate-y-1 hover:text-[#E31E24]">{tf("links.home")}</a>
                           
                        
                         <a href="/products" onClick={(e) => handleNavigation(e, "/products")} className="font-bold uppercase text-2xl tracking-widest text-gray-200 transition-transform hover:-translate-y-1 hover:text-[#E31E24]">{tf("links.products")}</a>
                ...
                <i className="ri-instagram-line hover:text-[#E31E24] cursor-pointer transition-transform hover:-translate-y-1"></i>
                        ...
                        <a href="#" className="font-bold uppercase text-2xl tracking-widest text-gray-200 transition-transform hover:-translate-y-1 hover:text-[#E31E24]">{tf("links.contact")}</a>
                        <a href="#" className="font-bold uppercase text-2xl tracking-widest text-gray-200 transition-transform hover:-translate-y-1 hover:text-[#E31E24]">{tf("links.about")}</a>
                    </div>
