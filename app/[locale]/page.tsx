    ...
    () => {
      ...
      mm.add(
        ...
        (context) => {
          ...
          const scene1 = gsap.timeline({
            scrollTrigger: {
              ...
              start: 'top top',
                ...
                `+=${isMobile ? window.innerHeight * 3 : window.innerHeight * 5}`,
              scrub: 1,
              pin: true,
          ...
          scene1
            .to('.video-content', { autoAlpha: 1, duration: 0.4 })
          ...
          flowTl.to(navRef.current, { y: 0, autoAlpha: 1, duration: 0.5 }).to(
            buddyRef.current,
            {
              y: '45vh',
              x: '-47vw',
          ...
          flowTl.to(
            storeRef.current,
            { yPercent: 0, duration: 2, ease: 'power3.inOut' },
            '-=0.5'
          );
          ...
          flowTl
            ...
            .to(
              navRef.current,
              { y: -100, autoAlpha: 0, duration: 0.6, ease: 'power2.in' },
              '<'
            );
